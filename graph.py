...
class Digraph(object):
    ...
    def add_node(self, node):
        ...
        #self.edges is a dictionary with keys of nodes, where the values are lists of edges
    ...
    def add_edge(self, edge):
        ...
        in the  graph."""
        if not(self.has_node(edge.get_source()) and
               self.has_node(edge.get_destination())):
            raise ValueError
        else:
            #add the edge to the list of nodes associated with the source node of the edge
